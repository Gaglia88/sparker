...
/**
  ...
  * @since 2016/12/07
  */
case class BlockDirty(blockID: Long, profiles: Array[Set[Long]], var entropy: Double = -1, var clusterID: Integer = -1, blockingKey: String = "") extends BlockAbstract with Serializable {
